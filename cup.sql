...
--
-- Хост: localhost:3306
-- Время создания: Май 27 2022 г., 09:03
...
(3, 'ddd02c62ff19f4aa90cea03015f5db938663ca1b', 'portfolio-detail-image-3.png', 'image/png', 'png', 48855, 0, '2022/01/20/', NULL, NULL, 'c4f70112fac9cb40083a17ea5117a5d4ee6aa9c3', 'public', 1, 'photos', '2022-01-20 11:27:26', '2022-01-20 11:27:26'),
...
--
-- Дамп данных таблицы `cataloggrs`
--

INSERT INTO `cataloggrs` (`id`, `name`, `url`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Детский праздник', 'detskij-prazdnik', 1, NULL, NULL),
...
--
-- Структура таблицы `cataloggr_productgr`
--
...
--
-- Дамп данных таблицы `cataloggr_productgr`
--

INSERT INTO `cataloggr_productgr` (`id`, `cataloggr_id`, `productgr_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL),
(2, 1, 2, NULL, NULL),
(3, 7, 3, NULL, NULL),
(4, 7, 4, NULL, NULL),
...
INSERT INTO `categories` (`id`, `name`, `url`, `active`) VALUES
(2, 'Детское меню', 'detskoe-menyu', 1),
...
--
-- Структура таблицы `category_g_r_s`
--
...
INSERT INTO `category_portfolios` (`id`, `name`, `url`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Фуршет', 'category1', 1, NULL, NULL),
...
--
-- Структура таблицы `category_portfolio_portfolio`
--
...
--
-- Дамп данных таблицы `category_portfolio_portfolio`
--

INSERT INTO `category_portfolio_portfolio` (`id`, `category_portfolio_id`, `portfolio_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL),
(2, 3, 3, NULL, NULL),
(3, 8, 25, NULL, NULL),
(6, 2, 24, NULL, NULL),
...
--
-- Структура таблицы `category_styledets`
--
...
--
-- Дамп данных таблицы `category_styledets`
--

INSERT INTO `category_styledets` (`id`, `name`, `url`, `shortdesc`, `desc`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Стиль для детского стола', 'styledetstol', '<p>фыв</p><p>фыв</p>', '<p>фывфы</p><p>фыв</p>', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `category_styledet_portfolio`
--
...
--
-- Дамп данных таблицы `category_styledet_portfolio`
--

INSERT INTO `category_styledet_portfolio` (`id`, `category_styledet_id`, `portfolio_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL),
(2, 1, 24, NULL, NULL),
(3, 1, 23, NULL, NULL);
...
--
-- Структура таблицы `category_styledet_productgr`
--
...
--
-- Структура таблицы `category_stylevzs`
--
...
--
-- Дамп данных таблицы `category_stylevzs`
--

INSERT INTO `category_stylevzs` (`id`, `name`, `url`, `shortdesc`, `desc`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Стиль для взрос стола 1', 'katalog1', '<p>Отношение к клиенту. С уважением и думая об интересе клиента.</p><p>Внимание к деталям. Все продумано.</p>', '<p>Отношение к клиенту. С уважением и думая об интересе клиента.</p><p>Внимание к деталям. Все продумано.</p><p>Индивидуальный подход. Разработаем блюдо под вас.</p><p>С любовью к делу</p><p>Выбирая только лучшее, как для себя. Чтобы вызывало восторг и кайф.</p><p>Фермерские продукты, необычные сочетания и овощи</p><p>Путь написать, основываясь на свои ценности.</p><p><br></p>', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `category_stylevz_portfolio`
--
...
--
-- Дамп данных таблицы `category_stylevz_portfolio`
--

INSERT INTO `category_stylevz_portfolio` (`id`, `category_stylevz_id`, `portfolio_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL),
(2, 1, 24, NULL, NULL),
(3, 1, 23, NULL, NULL);
...
--
-- Структура таблицы `category_stylevz_productgr`
--
...
--
-- Дамп данных таблицы `catformats`
--

INSERT INTO `catformats` (`id`, `title`, `desc`, `url`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Банкет', '<p>краткое описание категории</p>', 'banket', 1, NULL, NULL),
(2, 'Фуршет', '<p>Этот формат мероприятия характеризуется тем, что все угощения размещаются на&nbsp;столах и при этом нет стульев. Дополнительно могут быть выставлены коктейльные столы. Гости сами выбирают для себя еду и напитки. Официанты&nbsp;разносят некоторые блюда и помогают гостям с выбором. Приглашённые едят стоя или свободно передвигаются по&nbsp;залу, легко и&nbsp;непринужденно общаясь, с кем пожелают.</p>', 'furshet', 1, NULL, NULL),
...
--
-- Структура таблицы `catformat_format`
--
...
--
-- Структура таблицы `format_review`
--
...
INSERT INTO `f_a_q_s` (`id`, `title`, `body`, `enabled`, `created_at`, `updated_at`) VALUES
(1, 'Какова средняя стоимость мероприятия?', 'Зависит от типа мероприятия, количества гостей и множества других факторов. На данный вопрос менеджер ответит только после получения вводной информации о планируемом проекте.', 1, NULL, NULL),
...
--
-- Структура таблицы `garantkachestvas`
--
...
--
-- Дамп данных таблицы `garantkachestvas`
--

INSERT INTO `garantkachestvas` (`id`, `title`, `hero`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Отношение к клиенту', '794', 1, '2022-04-13 10:45:56', '2022-04-15 04:36:00'),
...
--
-- Дамп данных таблицы `ourps`
--

INSERT INTO `ourps` (`id`, `title`, `dolzhn`, `desc`, `hero`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Евгений', 'шеф-повар', 'Ежегодно наша компания обслуживает более 1000 полноценных мероприятий различного формата', NULL, 1, '2022-04-13 11:53:14', '2022-04-13 11:53:14'),
...
INSERT INTO `portfolios` (`id`, `name`, `url`, `kolperson`, `mestoprov`, `dataprov`, `formatprov`, `linkvideo`, `active`, `doptxt`, `oncenterslider`, `onstyleslider`, `created_at`, `updated_at`) VALUES
(1, 'Пикник в цветущем саду', 'korporativ-v-sadu', '9', 'Сад в Ростовской области', '2021-05-06', 'Гала-ужин', NULL, 1, NULL, 1, 1, NULL, NULL),
...
--
-- Структура таблицы `portfolio_review`
--
...
--
-- Дамп данных таблицы `portfolio_review`
--

INSERT INTO `portfolio_review` (`id`, `portfolio_id`, `review_id`, `created_at`, `updated_at`) VALUES
(3, 1, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `povodis`
--
...
CREATE TABLE `productgrs` (
  ...
  `weight_per_unit` double(8,2) DEFAULT NULL,
...
--
-- Дамп данных таблицы `productgrs`
--

INSERT INTO `productgrs` (`id`, `name`, `description`, `url`, `price_per_unit`, `price_full`, `composition`, `weight_per_unit`, `countpr`, `weight_full`, `protein`, `fat`, `carbohydrates`, `tooltip1`, `tooltip2`, `tooltip3`, `tooltip4`, `sp1`, `sp2`, `sp3`, `sp4`, `sp5`, `naborot`, `active`, `popular`, `created_at`, `updated_at`) VALUES
(1, 'Детский праздник 10+10', '<p>апрапрапр</p>', 'detskij-prazdnik-10-10', 25400, 25400, '<p>фывфыв</p>', 0.00, 1, 0.00, NULL, NULL, NULL, 1, 1, 0, 0, 'Детское меню', 'Закуски', 'Напитки', 'Оборудование', NULL, '10', 1, 1, NULL, NULL),
...
INSERT INTO `products` (`id`, `name`, `description`, `url`, `price_per_unit`, `price_full`, `composition`, `weight_per_unit`, `countpr`, `weight_full`, `protein`, `fat`, `carbohydrates`, `tooltip1`, `tooltip2`, `tooltip3`, `tooltip4`, `active`, `popular`, `hero`) VALUES
(1, 'Деликатес в мини-баночке с моцареллой и песто', '<p>Свежеприготовленный соус песто из зеленого базилика, пармезана и оливкового масла в сочетании с мини-моцареллой и помидоркой черри под бальзамическим уксусом.</p>', 'delikates-v-mini-banochke-s-mocarelloj-i-pesto', 150, 150, '<p>Моцарелла, помидор черри, базилик зеленый, чеснок, сыр пармезан, кедровый орех, оливковое масло, бальзамический уксус, орегано</p>', 30.00, 10, 30.00, NULL, NULL, NULL, 1, 1, 1, 1, 1, 0, NULL),
(2, 'Деликатес в мини-баночке с сыром и курагой', '<p>Два вида сыра: Фрибуржуа и Красный чеддер, в компании с медом, дроблеными орехами и курагой.</p>', 'delikates-v mini-banochke-s-syrom-i-kuragoj', 150, 150, '<p>Сыр Фрибуржуа, сыр Маасдам, курага, мед, орех грецкий, орех кешью.</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 1, 1, 1, 1, 1, 1, NULL),
(3, 'Креветка в беконе с томатным соусом табаско', '<p>Королевская креветка, завернутая в бекон. Подается с соусом на основе томатов и табаско.</p>', 'krevetka-v-bekone-s-tomatnym-sousom-tabasko', 150, 150, '<p>Королевская креветка, бекон с/к, томаты, чеснок, табаско, лайм.</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 1, 0, 0, 1, 1, NULL),
(4, 'Лангустина в тесте филло с авторским соусом', '<p>Лангустины завернуты в тончайшее греческое тесто филло с пикантно-пряным соусом.</p>', 'langustina-v-teste-fillo-s-avtorskim-sousom', 150, 150, '<p>лангустин, тесто филло, соус 1000 островов</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(5, 'Деликатес в мини-баночке с креветкой и персиком', '<p>Королевская креветка в сочетании с нежным персиком и обжаренным томатом черри. Подается с экзотическим соусом.</p>', 'delikates-v-mini-banochke-s-krevetkoj-i-persikom', 150, 150, '<p>королевская креветка, персик, томат черри, чеснок, оливковое масло, соус 1000 островов</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(6, 'Деликатес в мини-баночке с лососем', '<p>Деликатес из нежной семги домашнего посола под пикантным сливочным соусом. Соус приготовлен из сливочного сыра и хрена, с добавлением укропа.</p>', 'delikates-v-mini-banochke-s-lososem', 150, 150, '<p>семга слабосоленая, сливочный сыр, корнишон, укроп, перец черный</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(7, 'Деликатес из острой утки с райским яблочком', '<p>Острая утиная грудка объединяется с нежной моцареллой и запеченным райским яблочком.</p>', 'delikates-iz-ostroj-utki-s-rajskim-yablochkom', 150, 150, '<p>Утка, моцарелла,райское яблоко, соевый соус, имбирь, табаско, мед, винный уксус, соус наршараб</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(8, 'Деликатес в мини-баночке с бужениной и сливочным хреном', '<p>Домашняя буженина в сочетании с корнишоном под пикантным сливочным соусом из хрена.</p>', 'delikates-v-mini-banochke-s-buzheninoj-i-slivochnym-hrenom', 150, 150, '<p>Свинина вырезка, корнишон, сливочный хрен, укроп, айсберг, тмин, перец, соль, чеснок.</p>', 30.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(9, 'Деликатес из голубого сыра с виноградом', '<p>Кулинарный изыск из сочетания двух сыров: сыра GrandBlu с голубой плесенью и сыра Филадельфия, с виноградом внутри, панированный ореховой крошкой - грецкий и кешью.</p>', 'delikates-iz-golubogo-syra-s-vinogradom', 150, 150, '<p>Сыр GrandBlu с голубой плесенью, сыр Филадельфия, виноград, орех грецкий, орех кешью.</p>', 0.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(10, 'Ромовый шарик', '<p>Нежный бисквит с добавлением немецкого какао и дробленного поджаренного грецкого ореха пропитан темным ромом&nbsp;и покрыт глазурью из бельгийского шоколада</p>', 'romovyj-sharik', 150, 150, '<p>Бисквит, грецкий орех, какао, темный ром, шоколад, сливочное масло.</p>', 0.00, 1, 30.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
...
(18, 'Брускетта с моцареллой и помидором с соусом песто', '<p>Брускетта с изысканным сочетанием молодого сыра моцарелла и свежего помидора под бальзамическим кремом.</p>', 'brusketta-s-mocarelloj-i-pomidorom-s-sousom-pesto', 180, 180, '<p>Чиабатта, моцарелла, соус песто, помидор, оливковое масло</p>', 20.00, 1, 20.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(19, 'Брускетта с голубым сыром и карамелизованной грушей', '<p>Брускетта с изысканным сочетанием ароматного голубого сыра GrandBlu, нежной, таящей во рту карамелизиванной груши и пряного грецкого ореха.</p>', 'brusketta-s-golubym-syrom-i-karamelizovannoj-grushej', 180, 180, '<p>Чиабатта, сыр GrandBlu с голубой плесенью, груша, сахар, орех грецкий, оливковое масло</p>', 20.00, 1, 20.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(20, 'Брускетта с печеным сладким перцем и сыром фета', '<p>Брускетта с печеным сладким перцем и сыром фета</p>', 'brusketta-s-pechenym-sladkim-percem-i-syrom-feta', 180, 180, '<p>Чиабатта, сыр фета, перец красный, оливковое масло</p>', 20.00, 1, 20.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(21, 'Брускетта с пармской ветчиной и вялеными томатами', '<p>Брускетта с изысканным сочетанием пармской ветчины с мягким пряным вкусом, пикантными вялеными томатами и каперсами</p>', 'brusketta-s-parmskoj-vetchinoj-i-vyalenymi-tomatami', 180, 180, '<p>Чиабатта, пармская ветчина, каперсы, вяленые томаты, творожный сыр, оливковое масло</p>', 20.00, 1, 20.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(22, 'Чиабатта с куриным филе и свежими овощами', '<p>Итальянская чиабатта с начинкой из нежной ароматной курочки, сочного помидора и хрустящего салат айсберг со сливочно-творожным соусом.</p>', 'chiabatta-s-kurinym-file-i-svezhimi-ovoshchami', 200, 200, '<p>Чиабатта, курица, помидор, салат айсберг, сливочно-творожный соус, оливковое масло, сухой чеснок.</p>', 0.00, 1, 250.00, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL),
(23, 'Чиабатта с пепперони и свежими овощами', '<p>Итальянская чиабатта с начинкой из пикантной пепперони, свежих и соленых огурчиков и хрустящим салатом айсберг. Подается с домашним сырным соусом на основе 3-х сыров.</p>', 'chiabatta-s-pepperoni-i-svezhimi-ovoshchami', 200, 200, '<p>Чиабатта, пепперони, огурец свежий, огурец соленый, салат айсберг, сырный соус.</p>', 0.00, 1, 250.00, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL),
(24, 'Чиабатта с моцареллой и печеными овощами', '<p>Итальянская чиабатта с начинкой из печенного перца, баклажана, сочного помидора и сыра моцарелла со сливочно-творожным соусом.</p>', 'chiabatta-s-mocarelloj-i-pechenymi-ovoshchami', 200, 200, '<p>Чиабатта, сладкий перец, баклажан, помидор, моцарелла, салат айсберг, сливочно-творожный соус.</p>', 0.00, 1, 250.00, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL),
(25, 'Чиабатта с лососем и  авокадо', '<p>Итальянская чиабатта с начинкой из слабосоленого лосося, авокадо и свежего огурчика с пикантным соусом 1000 островов.</p>', 'chiabatta-s-lososem-i-avokado', 300, 300, '<p>Чиабатта, семга с/с, авокадо, огурец свежий, салат айсберг, соус 1000 островов.&nbsp;</p>', 0.00, 1, 250.00, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL),
...
(29, 'Закусочный поднос с 24 блинными мини-рулетами', '<p>Слабосоленный лосось с творожным мусом. Поджаренные грибочки с луком-шалот и мускатным орехом. Вяленые томаты и оливки с тимьяном. Рассчитан на 10-12 человек.</p>', 'zakusochnyj-podnos-s-24-blinnymi-mini-ruletami', 3100, 3100, '<p>Молоко, яйцо, мука, творожный сыр, вяленый томат, оливки Каламата, лосось с/с, шампиньоны, лук шалот, тимьян</p>', 1140.00, 1, 1147.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(30, 'Чайный поднос с 24 блинными мини-рулетами', '<p>Шоколадный мусс с голубикой и орехом. Сливочный крем с клубникой и мятой. Рассчитан на 10-12 человек</p>', 'chajnyj-podnos-s-24-blinnymi-mini-ruletami', 3100, 3100, '<p>Молоко, яйцо, мука, шоколад горький, черника, орех грецкий, тимьян, сливки, клубника, базилик</p>', 1130.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(31, 'Поднос с сырами, виноградом и сухофруктами', '<p>Поднос с сырами, виноградом и сухофруктами. Рассчитан на 10-12 человек</p>', 'podnos-s-syrami-vinogradom-i-suhofruktami', 3500, 3500, '<p>Камамбер (Россия), фета, качокавалло (коза/корова), маасдам, виноград, орех, сушеный абрикос, чернослив, мед, брусничный джем</p>', 1000.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(32, 'Поднос с европейскими сырами', '<p>Поднос с европейскими сырами</p>', 'podnos-s-evropejskimi-syrami', 0, 0, '<p>Камамбер буффало (Италия), Рокфор (Франция), Пармезан (Италия), Пекорино (Италия), виноград, орех, сушеный абрикос, чернослив, мед, брусничный джем</p>', 0.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(33, 'Поднос с мясными деликатесами', '<p>Поднос с мясными деликатесами. Рассчитан на 10-12 человек.</p>', 'podnos-s-myasnymi-delikatesami', 4600, 4600, '<p>Прошутто Крудо,Коппа, Сальчичон, Салями, куриный рулет с черносливом, оливки, маслины, помидоры черри, медово-горчичный соус.</p>', 700.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
...
(36, 'Салат из запеченной свеклы и сливочного сыра под соусом песто', '<p>Запеченная свекла в собственном соку со шпинатом и сливочным сыром под соусом песто с добавлением кедрового ореха</p>', 'salat-iz-zapechennoj-svekly-i-slivochnogo-syra-pod-sousom-pesto', 150, 150, '<p>Запеченная свекла, шпинат, сливочный сыр, соус песто, кедровые орешки.</p>', 250.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(37, 'Настоящий греческий деликатес  с фетой и оливочками Каламата', '<p>Свежие овощи, заправленные итальянским оливковым маслом и бальзамическим уксусом, в сочетании с нежной фетой и оливками сорта Каламата.</p>', 'nastoyashchij-grecheskij-delikates-s-fetoj-i-olivochkami-kalamata', 200, 200, '<p>Помидор, огурец, перец сладкий, красный лук, сыр фета,оливки Каламата, оливковое масло, бальзамический уксус, сухой орегано.</p>', 250.00, 1, 150.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(38, 'Селедка на шубе', '<p>Неизменная классика, перевернутая с ног на голову. Селедочка уложена на овощную шубу.</p>', 'seledka-na-shube', 150, 150, '<p>селедка с/с, свекла, морковь, картошка, соус Провансаль, яйцо перепелиное, укроп.</p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
...
(41, 'Салат из курочки и шампиньонов на соусе дзадзики', '<p>Нежная маринованная курочка и жареные пряные шампиньоны на греческом соусе дзадзики из йогурта, свежего огурца и мяты.</p>', 'salat-iz-kurochki-i-shampinonov-na-souse-dzadziki', 250, 250, '<p>Куриное филе, шампиньоны, чиабатта, греческий йогурт, огурец, оливковое масло, мята, кинза.</p>', 250.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(42, 'Деликатес из курочки под соусом карри', '<p>Нежное куриное филе обжаривается с кусочками свежего ананаса в соусе карри с чесночком и свежим имбирем в сливках. Подается на подушке из киноа и зеленого горошка. Посыпается дробленым поджаренным орехом кешью.</p>', 'delikates-iz-kurochki-pod-sousom-karri', 240, 240, '<p>куриное филе, киноа, зеленый горошек, ананас, оливковое масло, карри, сливки, орех кешью</p>', 250.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(43, 'Салат из курочки, маринованных опят и сладкого перца', '<p>Курочка, сладкий перчик и маринованные опята готовятся в сковородке wok с добавлением соевого соуса. Подается под розовым соусом и листьями салата.</p>', 'salat-iz-kurochki-marinovannyh-opyat-i-sladkogo-perca', 260, 260, '<p>Куриное филе, маринованные опята, сладкий перец, соевый соус, розовый соус, красное сухое вино, листья салата.</p>', 250.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(44, 'Деликатес мексиканский острый', '<p>Маринованная в копченой паприке курочка, обжаренная со сладким перцем и красным луком на гриле на соусе гуакамоле и томатной сальсой с перчиком чили.&nbsp;</p>', 'delikates-meksikanskij-ostryj', 240, 240, '<p>Куриное филе, сладкий перец, авокадо, помидоры, красный лук, кинза, перец чили.</p>', 250.00, 1, 140.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(45, 'Салат из копченой курочки и свежих овощей', '<p>Нарезанная мелкими кусочками копченая курочка с сочетанием чернослива и свежего огурчика под шубой из молодой моркови.</p>', 'salat-iz-kopchenoj-kurochki-i-svezhih-ovoshchej', 200, 200, '<p>Копченая курица, огурец, морковь, чернослив, соус Провансаль.</p>', 250.00, 1, 140.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(46, 'Деликатес из индейки под соусом терияки с овощами-гриль', '<p>Филе индейки&nbsp;с&nbsp;овощным миксом обжарены на гриле с дымком. Подается под соусом терияки на подушке из ароматного кус-куса, с добавлением свежей мяты.</p>', 'delikates-iz-indejki-pod-sousom-teriyaki-s-ovoshchami-gril', 280, 280, '<p>&nbsp;индейка, перец сладкий, цуккини, лук красный, кускус, соус терияки, мята, кунжут.</p>', 250.00, 1, 140.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(47, 'Деликатес из отварной телятины и лангустин', '<p>Отварная телятина и домашняя курочка приправлены соусом Провансаль с добавлением маринованных огурчиков и свежего зеленого горошка. Подается с лангустинами и ложечкой щучьей икры</p>', 'delikates-iz-otvarnoj-telyatiny-i-langustin', 300, 300, '<p>говядина, курица, картофель, маринованный огурец, зеленый горошек, лангустин, соус Провансаль, салат романо, щучья икра</p>', 250.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(48, 'Деликатес из нежной утки под гранатовым соусом', '<p>Маринованная уточка обжаривается до золотистой корочки и запекается в духовке в собственном соку. Подается под гранатовым соусом с овощным миксом из сладкого перца, помидорок черри и листьев салата. Посыпается фисташковой крошкой.</p>', 'delikates-iz-nezhnoj-utki-pod-granatovym-sousom', 380, 380, '<p>Утиное филе, помидоры черри, сладкий перец, салатный микс, мед, соус наршараб, соевый соус.</p>', 100.00, 1, 90.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(49, 'Деликатес из пряной утки под клюквенным соусом', '<p>Утиная грудка обжаривается с веточкой тимьяна на оливковом масле и запекается в духовке в собственном соку. Подается под клюквенным соусом с салатом из рукколы и&nbsp;апельсиновой заправки. Посыпается поджаренными кедровыми орешками.</p>', 'delikates-iz-pryanoj-utki-pod-klyukvennym-sousom', 380, 380, '<p>утиное филе, салат руккола, апельсин, клюквенный соус, оливковое масло, мед, кедровый орех.</p>', 100.00, 1, 90.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(50, 'Деликатес из отварной семги под сыром Пармезан', '<p>Нежная семга, отваренная в пряных специях, уложена на овощную подушку. Подается с сыром Пармезан и красной икрой кижуч.</p>', 'delikates-iz-otvarnoj-semg-i-pod-syrom-parmezan', 350, 350, '<p>семга отварная, картофель, морковь, сыр Пармезан, соус Провансаль, красная икра нерки</p>', 100.00, 1, 80.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(52, 'Деликатес из креветок и маринованных шампиньонов под заправкой карри', '<p><span style=\"color: rgb(0, 0, 0);\">Деликатес из креветок, обжаренных на оливковом масле с чесночком, маринованных шампиньонов и листьев салата под пряно-сладкой заправкой карри.</span></p>', 'delikates-iz-krevetok-i-marinovannyh-shampinonov-pod-zapravkoj-karri', 360, 360, '<p><span style=\"color: rgb(0, 0, 0);\">Креветки, королевские маринованные шампиньоны, листья салата, соус карри, чиабатта, кунжут.</span></p>', 100.00, 1, 80.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(53, 'Деликатес из морепродуктов под медово-горчичной заправкой', '<p><span style=\"color: rgb(0, 0, 0);\">Деликатес из креветок и кальмаров, обжаренных на оливковом масле с чесночком,  мидий и молодых осьминожков с добавлением микса салатов и свежих огурчиков.</span></p>', 'delikates-iz-moreproduktov-pod-medovo-gorchichnoj-zapravkoj', 390, 390, '<p><span style=\"color: rgb(0, 0, 0);\">Креветки королевские, кальмары, мидии, огурец, перец сладкий, микс салатов, мед, зерновая горчица, оливковое масло.</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(54, 'Деликатес из семги с авокадо и вялеными томатами', '<p><span style=\"color: rgb(0, 0, 0);\">Красная рыбка замаринована и приготовлена особым способом с ломтиками авокадо и пикантными вялеными томатами под бальзамическим соусом с зернами горчицы.</span></p>', 'delikates-iz-semgi-s-avokado-i-vyalenymi-tomatami', 310, 310, '<p><span style=\"color: rgb(0, 0, 0);\">семга, авокадо, салат романо, вяленые томаты, оливковое масло, бальзамический уксус, зернистая горчица, мед, соль, перец.</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(55, 'Деликатес из запеченного картофеля черри и маринованного лосося', '<p><span style=\"color: rgb(0, 0, 0);\">Пикантный маринованный лосось и картофель черри, запеченный с веточкой розмарина, приправлены  медово-горчичной заправкой с сочным салатом романо</span></p>', 'delikates-iz-zapechennogo-kartofelya-cherri-i-marinovannogo-lososya', 340, 340, '<p><span style=\"color: rgb(0, 0, 0);\">семга гравлакс, картофель черри, салат романо, вяленые томаты, зеленый горошек, французская горчица, мед, бальзамический уксус.</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(56, 'Нисуаз', '<p><span style=\"color: rgb(0, 0, 0);\">Нисуаз</span></p>', 'nisuaz', 1, 1, '<p><span style=\"color: rgb(0, 0, 0);\">заправка лимонная, фасоль кенийская, соль, картофель отварной, петрушка, маслины жаренные, лук шалот, тунец филе, помидоры, тапенада из маслин</span></p>', 1.00, 1, 1.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(57, 'Лосось с киноа под азиатской заправкой', '<p>Лосось с киноа под азиатской заправкой</p>', 'losos-s-kinoa-pod-aziatskoj-zapravkoj', 1, 1, '<p><span style=\"color: rgb(0, 0, 0);\">киноа, авокада, чука, черри, лосось, понзу соус, кунжутное семечко, кинза, семена льна</span></p>', 1.00, 1, 1.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(58, 'Классический холодец', '<p><span style=\"color: rgb(0, 0, 0);\">Собран из трех видов мяса: телятина, домашняя курочка и свинина. Подается с мини-морковочкой и сливочным хреном.</span></p>', 'klassicheskij-holodec', 210, 210, '<p><span style=\"color: rgb(0, 0, 0);\">телятина, курица, свинина, вода, мини-морковь, сливочный хрен</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(59, 'Куриные шашлычки гриль', '<p><span style=\"color: rgb(0, 0, 0);\">Шашлычки готовятся с дымком на чугунной сковороде-гриль и подаются к столу с соусом на Ваш выбор. Благодаря подаче в подогреваемом мармите оптимальная температура и неизменный вкус блюда сохранится в течение всего торжества.</span></p>', 'kurinye-shashlychki-gril', 250, 250, '<p><span style=\"color: rgb(0, 0, 0);\">Куриное филе, перец сладкий, соль, перец, оливковое масло</span></p>', 120.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(60, 'Шашлычки гриль из семги', '<p><span style=\"color: rgb(0, 0, 0);\">Шашлычки готовятся с дымком на чугунной сковороде-гриль и подаются к столу с соусом на Ваш выбор. Благодаря подаче в подогреваемом мармите оптимальная температура и неизменный вкус блюда сохранится в течение всего торжества.</span></p>', 'shashlychki-gril-iz-semgi', 400, 400, '<p><span style=\"color: rgb(0, 0, 0);\">Семга, соль, перец</span></p>', 80.00, 1, 0.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(61, 'Овощные шашлычки гриль', '<p><span style=\"color: rgb(0, 0, 0);\">Шашлычки готовятся с дымком на чугунной сковороде-гриль и подаются к столу с соусом на Ваш выбор. Благодаря подаче в подогреваемом мармите оптимальная температура и неизменный вкус блюда сохранится в течение всего торжества.</span></p>', 'ovoshchnye-shashlychki-gril', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">Цуккини, перец сладкий, шампиньоны, баклажан, соль, перец, оливковое масло</span></p>', 100.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(62, 'Шашлычки гриль из креветок', '<p><span style=\"color: rgb(0, 0, 0);\">Шашлычки готовятся с дымком на чугунной сковороде-гриль и подаются к столу с соусом на Ваш выбор. Благодаря подаче в подогреваемом мармите оптимальная температура и неизменный вкус блюда сохранится в течение всего торжества.</span></p>', 'shashlychki-gril-iz-krevetok', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">Креветки тигровые, гребешок, лимон, соль, перец, оливковое масло</span></p>', 1.00, 1, 1.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(63, 'Картофель черри с розмарином', '<p><span style=\"color: rgb(0, 0, 0);\">Шашлычки готовятся с дымком на чугунной сковороде-гриль и подаются к столу с соусом на Ваш выбор. Благодаря подаче в подогреваемом мармите оптимальная температура и неизменный вкус блюда сохранится в течение всего торжества.</span></p>', 'kartofel-cherri-s-rozmarinom', 100, 100, '<p><span style=\"color: rgb(0, 0, 0);\">Картофель черри, соль, ррозмарин, оливковое масло</span></p>', 100.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(64, 'Лоранский пирог \"Ветчина с сыром\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-vetchina-s-syrom', 1500, 1500, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, ветчина, лук, сыр, яйцо куриное, сливки, мускатный орех</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(65, 'Лоранский пирог \"Курица с овощами\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-kurica-s-ovoshchami', 1700, 1700, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, курица, цуккини, сладкий перец, морковь, лук, сыр, яйцо куриное, сливки, карри</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(66, 'Лоранский пирог \"Итальянский с моцареллой и вялеными томатами\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij pirog-iItalyanskij-s-mocarelloj-i-vyalenymi-tomatami', 1700, 1700, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, моцарелла, помидоры черри, соус песто,яйцо куриное, сливки, орегано</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(67, 'Лоранский пирог \"Шпинат, печенный перец и сыр фета\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-shpinat-pechennyj-perec-i-syr-feta', 1700, 1700, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, шпинат, перец сладкий, сыр фета, лук, сыр, яйцо куриное, сливки</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(68, 'Лоранский пирог \"Грибной\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-gribnoj', 1700, 1700, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, грибы шампиньоны, лук, сыр, яйцо курное, сливки, тимьян</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(69, 'Лоранский пирог \"Щавель и голубой сыр\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-shchavel-i-goluboj-syr', 2100, 2100, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, щавель, сыр GrandBlu с голубой плесенью, яйцо куриное, сливки</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(70, 'Лоранский пирог \"Семга и брокколи\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-semga-i-brokkoli', 2100, 2100, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, семга, брокколи, соус песто, сыр, яйцо куриное, сливки</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, NULL),
(71, 'Лоранский пирог \"Малина и рикотта\"', '<p><span style=\"color: rgb(0, 0, 0);\">д=26 см</span></p>', 'loranskij-pirog-malina-i-rikotta', 2800, 2800, '<p><span style=\"color: rgb(0, 0, 0);\">песочное тесто, рикотта, яйцо куриное, малина, мята, сливки</span></p>', 1200.00, 1, 1200.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(72, 'Панна котта \"Клубника-базилик\"', '<p><span style=\"color: rgb(0, 0, 0);\">Легкий двухслойный десерт из нежной клубничной панна котты с добавлением ароматного зеленого базилика в сочетании с ягодами клубники в легком желе.</span></p>', 'panna-kotta-klubnika-bazilik', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">клубника, базилик, сливки, молоко, сахар, ваниль, сок клубничный, желатин.</span></p>', 100.00, 1, 80.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(73, 'Панна котта \"Вишня\"', '<p><span style=\"color: rgb(0, 0, 0);\">Нежная, воздушная панна котта в сочетании с аппетитной вишней в легком желе.</span></p>', 'panna-kotta-vishnya', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">вишня, сливки, молоко, сахар, ваниль, сок вишневый, желатин.</span></p>', 100.00, 1, 80.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(74, 'Домашний рыжик', '<p><span style=\"color: rgb(0, 0, 0);\">Медовые коржи из заварного теста пропитаны кремом нежного сливочного вкуса</span></p>', 'domashnij-ryzhik', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">молоко, мука, яйцо куриное, мед, сахар, ваниль, соль, лепестки миндаля</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(75, 'Фруктовая баночка', '<p><span style=\"color: rgb(0, 0, 0);\">Сочные фрукты прослоены нежным кремом на онове маскарпоне.</span></p>', 'fruktovaya-banochka', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">яблоко, груша, клубника, физалис, черника, виноград, мята</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(76, 'Лимонный десерт', '<p><span style=\"color: rgb(0, 0, 0);\">Нежный лимонный крем уложен на подушку из песочного теста и сверху покрыт соусом Птичье молоко</span></p>', 'limonnyj-desert', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">лимон, ваниль, сахар, мука, сливки, яйцо куриное, сливочное масло, соль.</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(77, 'Классический тирамису', '<p><span style=\"color: rgb(0, 0, 0);\">Бисквитные палочки пропитаны натуральным кофе, ликером Амаретто и кремом маскарпоне. Оформлен стружкой из горького шоколада.</span></p>', 'klassicheskij-tiramisu', 200, 200, '<p><span style=\"color: rgb(0, 0, 0);\">молоко, сливки, крахмал, сахар, сыр маскарпоне, сливки, палочки савоярди, горький шоколад, свежая мята</span></p>', 100.00, 1, 100.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(78, 'Десерт Морковный', '<p><span style=\"color: rgb(0, 0, 0);\">Ароматный пряный морковный корж с нотками корицы и мускатного ореха прослоен нежным кремом Чиз. Украшен орехом пекан.</span></p>', 'desert-morkovnyj', 350, 350, '<p><span style=\"color: rgb(0, 0, 0);\">Морковь, яблоко, грецкий орех, мука, сахар, мускатный орех, корица, творожный сыр, сахарная пудра</span></p>', 100.00, 1, 120.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(79, 'Брауни с вишней', '<p><span style=\"color: rgb(0, 0, 0);\">Нежное шоколадное пирожное с добавлением свежей вишни и прослойки из сливочного сыра. Брауни покрыт красивой и хрустящей корочкой, а также нежной, влажной и тающей во рту начинкой.</span></p>', 'brauni-s-vishnej', 350, 350, '<p><span style=\"color: rgb(0, 0, 0);\">Шоколад горький, мука, сахар, сливочное масло, яйцо куриное, растительное масло, сливочный сыр, вишня.</span></p>', 250.00, 1, 150.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(80, 'Базиликовый пунш', '<p><span style=\"color: rgb(0, 0, 0);\">Освещающий пунш с нотками свежего базилика и лимонного фреша.</span></p>', 'bazilikovyj-punsh', 2000, 2000, '<p><span style=\"color: rgb(0, 0, 0);\">содовая, лимонный сок, сахарный сироп, базилик, грейпфрут</span></p>', 6.00, 1, 6.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(81, 'Тропический пунш', '<p><span style=\"color: rgb(0, 0, 0);\">Тонизирующий пунш из свежевыжатого апельсинового сока с добавлением мякоти банана и груши в сочетании с ананасовым соком.</span></p>', 'tropicheskij-punsh', 2500, 2500, '<p><span style=\"color: rgb(0, 0, 0);\">содовая, свежевыжатый апельсиновый сок, ананасовый сок, сахарный сироп, банан, груша.</span></p>', 6.00, 1, 6.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(82, 'Лимонад \"Тархун\"', '<p><span style=\"color: rgb(0, 0, 0);\">Тонизирующий пунш из свежевыжатого апельсинового сока с добавлением мякоти банана и груши в сочетании с ананасовым соком.</span></p>', 'limonad-tarhun', 2500, 2500, '<p><span style=\"color: rgb(0, 0, 0);\">содовая, лимонный сок, сахарный сироп, тархун.</span></p>', 6.00, 1, 6.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(83, 'Пунш \"Клубника с розмарином\"', '<p><span style=\"color: rgb(0, 0, 0);\">Освежающий пунш с интересным пряным вкусом розмарина и ароматом клубники.</span></p>', 'punsh-klubnika-s-rozmarinom', 2700, 2700, '<p><span style=\"color: rgb(0, 0, 0);\">содовая, клубника, клубничный сок, сахарный сироп, сироп розмариновый.</span></p>', 6.00, 1, 6.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(84, 'Домашний компот', '<p><span style=\"color: rgb(0, 0, 0);\">Домашний компот, сварен из яблок и вишни с добавлением черной смородины.</span></p>', 'domashnij-kompot', 300, 300, '<p><span style=\"color: rgb(0, 0, 0);\"> яблоки, вода, вишня, черная смородина, сахарный сироп</span></p>', 1.00, 1, 1.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(85, 'Чай', '<p><span style=\"color: rgb(0, 0, 0);\">1 порция на 1 человека включает:</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 150 мл чая (кипяток в термосе + чай пакетированный)</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 1 бумажный стакан, </span></p><p><span style=\"color: rgb(0, 0, 0);\">- 1 размешиватель</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 15 г лимона</span></p><p><span style=\"color: rgb(0, 0, 0);\">- сахар</span></p>', 'chaj', 190, 190, '<p>чай, <span style=\"color: rgb(0, 0, 0);\">бумажный стакан, размешиватель, молоко, лимон, сахар</span></p>', 150.00, 1, 150.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
(86, 'Кофе', '<p><span style=\"color: rgb(0, 0, 0);\">1 порция на 1 человека включает:</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 150 мл кофе (свежесваренный кофе в термосе)</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 1 бумажный стакан,</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 1 размешиватель</span></p><p><span style=\"color: rgb(0, 0, 0);\">- 20 мл молоко </span></p><p><span style=\"color: rgb(0, 0, 0);\">- сахар</span></p>', 'kofe', 190, 190, '<p><span style=\"color: rgb(0, 0, 0);\">кофе, бумажный стакан, размешиватель, молоко, сахар</span></p>', 150.00, 1, 150.00, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, NULL),
...
--
-- Структура таблицы `product_productgr`
--
...
--
-- Дамп данных таблицы `product_productgr`
--

INSERT INTO `product_productgr` (`id`, `product_id`, `productgr_id`, `created_at`, `updated_at`) VALUES
(2, 84, 1, NULL, NULL),
(3, 89, 1, NULL, NULL),
(4, 90, 1, NULL, NULL),
(5, 34, 2, NULL, NULL),
...
--
-- Структура таблицы `product_productgr_2`
--
...
--
-- Дамп данных таблицы `product_productgr_2`
--

INSERT INTO `product_productgr_2` (`id`, `product_id`, `productgr_id`, `created_at`, `updated_at`) VALUES
(2, 4, 1, NULL, NULL),
(3, 9, 1, NULL, NULL),
(4, 20, 1, NULL, NULL),
(5, 29, 1, NULL, NULL),
...
--
-- Структура таблицы `product_productgr_3`
--
...
--
-- Дамп данных таблицы `product_productgr_3`
--

INSERT INTO `product_productgr_3` (`id`, `product_id`, `productgr_id`, `created_at`, `updated_at`) VALUES
(2, 80, 1, NULL, NULL),
(3, 59, 2, NULL, NULL),
(4, 61, 2, NULL, NULL),
(6, 93, 4, NULL, NULL),
...
--
-- Структура таблицы `product_productgr_4`
--
...
--
-- Дамп данных таблицы `product_productgr_4`
--

INSERT INTO `product_productgr_4` (`id`, `product_id`, `productgr_id`, `created_at`, `updated_at`) VALUES
(2, 92, 1, NULL, NULL),
(3, 92, 2, NULL, NULL),
(4, 93, 6, NULL, NULL),
(5, 95, 6, NULL, NULL),
...
--
-- Структура таблицы `product_productgr_5`
--
...
INSERT INTO `quizzes` (`id`, `title`, `name`, `price`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Велком зона', 'welcome_zone', 1000, 1, '2022-04-04 07:44:35', '2022-04-04 07:44:35'),
...
INSERT INTO `reviews` (`id`, `url`, `h1`, `title`, `description`, `keywords`, `hero`, `name`, `text`, `active`, `created_at`, `updated_at`) VALUES
(1, 'rev1', NULL, NULL, NULL, NULL, '774', 'Николай П.', '<p>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.</p><p>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.</p><p>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.</p>', 1, '2022-04-12 09:23:15', '2022-04-15 03:34:24'),
(2, 'rev2', NULL, NULL, NULL, NULL, NULL, 'Феофаний', '<p>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.</p><p><br></p><p> </p><p><br></p><p>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.</p>', 1, '2022-04-12 09:23:15', '2022-04-15 04:49:33'),
(3, 'rev3', NULL, NULL, NULL, NULL, NULL, 'Николай', 'Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.<br> <br>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.', 1, '2022-04-12 09:23:15', '2022-04-13 16:43:05'),
(4, 'rev4', NULL, NULL, NULL, NULL, NULL, 'Николай', 'Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.<br> <br>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.', 1, '2022-04-12 09:23:15', '2022-04-13 16:43:19'),
(5, 'rev5', NULL, NULL, NULL, NULL, NULL, 'Николай', 'Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.<br> <br>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.', 1, '2022-04-12 09:23:15', '2022-04-13 16:43:29'),
(6, 'rev6', NULL, NULL, NULL, NULL, NULL, 'Николай', 'Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.<br> <br>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.', 1, '2022-04-12 09:23:15', '2022-04-13 16:43:41'),
(7, 'rev7', NULL, NULL, NULL, NULL, NULL, 'Николай', 'Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем. Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие. Большое Вам спасибо за Вашу работу, очень выручаете. Рекомендую всем.<br> <br>Второй год пользуюсь Вашими услугами. Очень довольна. Заказ привозят вовремя, продукты очень свежие.', 1, '2022-04-12 09:23:15', '2022-04-13 16:43:48');
...
--
-- Дамп данных таблицы `slidergls`
--

INSERT INTO `slidergls` (`id`, `title`, `desc`, `datepub`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Пасха', '<p>Пасха</p>', '2022-04-23', 1, '2022-04-13 08:04:51', '2022-04-13 08:04:51');

-- --------------------------------------------------------

--
-- Структура таблицы `s_e_o_s`
--
...
--
-- Дамп данных таблицы `s_e_o_s`
--

INSERT INTO `s_e_o_s` (`id`, `page`, `page_url`, `h1`, `title`, `description`, `keywords`, `subtitle`, `fulldesc`, `phone`, `email`, `city`, `street`, `weekdays`, `weekend`, `link1`, `link2`, `link3`, `doptitle1`, `doptxt1`, `doptitle2`, `doptxt2`, `doptxt3`, `codkarti`, `codhtml`, `hero`, `created_at`, `updated_at`) VALUES
(1, 'main', 'index', 'Премиум кейтеринг', 'Главная страница', 'Описание главной', NULL, 'Организация эстетичных мероприятий', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Светлана', '<p><span style=\"color: rgb(79, 79, 79);\">Ежегодно наша компания обслуживает более 1000 полноценных мероприятий различного формата fdsgdfgdfgdfg</span></p>', 'Александр', '<p><span style=\"color: rgb(79, 79, 79);\">Ежегодно наша компания обслуживает более 1000 полноценных мероприятий различного формата</span></p>', NULL, NULL, NULL, NULL, NULL, '2022-04-13 08:05:28'),
(2, 'contacts', 'kontakty', 'Контакты', 'Контакты', 'Описание Контакты', NULL, NULL, NULL, '8 (800) 700-64-46', 'cupkatering@gmail.com', 'г. Ростов-на-Дону,', 'ул. Грисенко, 23 а', 'с 7.00 до 22.00', NULL, 'https://rutube.ru/channel/25960471/videos/', 'https://www.youtube.com/channel/UCv2LWqIi36WV-yvPLmPFxfQ', 'https://vk.com/3', NULL, NULL, NULL, NULL, NULL, '<iframe\r\nsrc=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2709.1802030502354!2d39.73103001586234!3d47.232620921729776!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40e3b9a33d89d167%3A0x97d93f4c088c3171!2z0JrRgNCw0YHQvdC-0LDRgNC80LXQudGB0LrQsNGPINGD0LsuLCAxNTMsINCg0L7RgdGC0L7Qsi3QvdCwLdCU0L7QvdGDLCDQoNC-0YHRgtC-0LLRgdC60LDRjyDQvtCx0LsuLCAzNDQwMjI!5e0!3m2!1sru!2sru!4v1623240532720!5m2!1sru!2sru\"\r\nwidth=\"100%\" height=\"100%\" style=\"border: 0\" allowfullscreen=\"\" loading=\"lazy\"></iframe>', NULL, NULL, NULL, '2022-04-15 11:06:07'),
(3, 'company', 'o-kompanii', 'О компании', 'О компании', 'Описание О компании', NULL, 'С другой стороны рамки и место обучения кадров играет важную роль в формировании дальнейших направлений развития. Задача организации, в особенности же постоянный количественный рост и сфера нашей активности требуют от нас анализа направлений прогрессивного развития. Равным образом рамки и место обучения кадров позволяет выполнять важные задания по разработке систем массового участия.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Светлана', '<p><span style=\"color: rgb(79, 79, 79);\">Ежегодно наша компания обслуживает более 1000 полноценных мероприятий различного формата</span></p>', 'Александр', '<p><span style=\"color: rgb(79, 79, 79);\">Ежегодно наша компания обслуживает более 1000 полноценных мероприятий различного формата</span></p>', NULL, NULL, NULL, NULL, NULL, '2022-04-12 17:51:24'),
(4, 'dostavka', 'dostavka-oplata', 'Доставка и оплата', 'Доставка и оплата', 'Описание доставка и оплата', NULL, NULL, '<p>В случае заказа свыше&nbsp;<strong>10 т.р.</strong>&nbsp;необходима предоплата в размере&nbsp;<strong>30%</strong></p><p>В случае уведомления об отмене заказа менее чем за&nbsp;<strong>12</strong>&nbsp;часов до мероприятия/ доставки, взымается&nbsp;<strong>50%</strong>&nbsp;от суммы всего заказа или суммы произведенной предоплаты</p><p>В случае уведомления об отмене заказа менее чем за&nbsp;<strong>14</strong>&nbsp;дней в декабре месяце (каждого года) до мероприятия/ доставки, взымается&nbsp;<strong>50%</strong>&nbsp;от суммы всего заказа или суммы произведенной предоплаты</p>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'БЕСПЛАТНАЯ ДОСТАВКА ПРИ СУММЕ ЗАКАЗА', '<p>в пределах Ростова-на-Дону</p>', 'Оплата', '<p>Оплатить свой заказ Вы можете наличными банковской картой безналичным расчетом на р/с организаци.</p><p>Какие-либо скидки не распространяются на \"готовые решения\" и \"меню блюд\", возможны исключительно на предоставление кейтеринга</p>', 'от 5000 руб.', NULL, NULL, NULL, NULL, '2022-04-15 03:46:47'),
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `fio`, `city`, `street`, `dom`, `com`, `email_verified_at`, `password`, `role`, `remember_token`, `created_at`, `updated_at`, `permissions`) VALUES
(2, 'admin', 'notify@umax.agency', '+7 (960) 445 24 38', 'Anton Zh', 'Ростов', 'комм', '11', NULL, NULL, '$2y$10$UcCxnpsIF7F51fQmNsYLkuV9vkaNvJDaH5Okvdm9D6sZH6HSAYwDW', 2, 'pn5sim9iPdFrkwIiUAKqpODmG9kC9aCpp99lsk4gtCkBPIRxIrmBdw15vCsf', '2022-05-04 06:56:56', '2022-05-10 16:29:58', '{\"platform.systems.roles\":true,\"platform.systems.users\":true,\"platform.systems.attachment\":true,\"platform.index\":true}'),
...
INSERT INTO `vacancies` (`id`, `title`, `experience`, `workload_short`, `workload_full`, `city`, `salary`, `responsibility`, `requirements`, `conditions`, `datepub`, `url`, `description`, `keywords`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Шеф-повар123', '1-3 года', 'Полный день', '1-Полная занятость, сменный график', 'Ростов-на-Дону', 120000, '<p>Работа на фрезерно-гравировальном станке 3D Flexicam (приоритетно)</p><p>                                    </p><p>Работа на лазерно-гравировальном станке (возможно - от загрузки производственных участков)</p><p>                                    </p><p>Функции при работе на оборудовании - обработка и роспуск листовых материалов - акрил, пластик, фанера.</p>', '<p>Знание спец. программ</p><p>                                    </p><p>Высшее тех. образование - желательно.</p>', '<p>График работы сменный.</p><p>                        </p><p>Место работы - Красноармейская, 153</p><p>                        </p><p>Соц. пакет, своевременная выплата з/пл.</p>', NULL, 'shefpovar1', NULL, NULL, 1, '2022-04-12 09:23:28', '2022-04-14 17:35:48'),
(2, 'Шеф-повар', '1-3 года', 'Полный день', 'Полная занятость, сменный график', 'Ростов-на-Дону', 110000, '<p>Работа на фрезерно-гравировальном станке 3D Flexicam (приоритетно)</p><p>                                    </p><p>Работа на лазерно-гравировальном станке (возможно - от загрузки производственных участков)</p><p>                                    </p><p>Функции при работе на оборудовании - обработка и роспуск листовых материалов - акрил, пластик, фанера.</p>', '<p>Знание спец. программ</p><p>                                    </p><p>Высшее тех. образование - желательно.</p>', '<p>График работы сменный.</p><p>                        </p><p>Место работы - Красноармейская, 153</p><p>                        </p><p>Соц. пакет, своевременная выплата з/пл.</p>', NULL, 'shefpovar2', NULL, NULL, 1, '2022-04-12 09:23:28', '2022-04-14 10:20:55'),
(3, 'Шеф-повар', '1-3 года', 'Полный день', 'Полная занятость, сменный график', 'Ростов-на-Дону', 100000, '<p>Работа на фрезерно-гравировальном станке 3D Flexicam (приоритетно)</p><p>                                    </p><p>Работа на лазерно-гравировальном станке (возможно - от загрузки производственных участков)</p><p>                                    </p><p>Функции при работе на оборудовании - обработка и роспуск листовых материалов - акрил, пластик, фанера.</p>', '<p>Знание спец. программ</p><p>                                    </p><p>Высшее тех. образование - желательно.</p>', '<p>График работы сменный.</p><p>                        </p><p>Место работы - Красноармейская, 153</p><p>                        </p><p>Соц. пакет, своевременная выплата з/пл.</p>', NULL, 'shefpovar3', NULL, NULL, 1, '2022-04-12 09:23:28', '2022-04-14 10:20:37');
...
INSERT INTO `youtubes` (`id`, `title`, `link`, `coment`, `active`, `created_at`, `updated_at`) VALUES
(1, 'video1', 'boZzgEC22UE', '<p>видео 1</p>', 1, '2022-02-07 05:00:41', '2022-02-07 05:01:24'),
...
--
-- Индексы таблицы `cataloggrs`
--
ALTER TABLE `cataloggrs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `cataloggr_productgr`
--
ALTER TABLE `cataloggr_productgr`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cataloggr_productgr_cataloggr_id_foreign` (`cataloggr_id`),
  ADD KEY `cataloggr_productgr_productgr_id_foreign` (`productgr_id`);
...
--
-- Индексы таблицы `category_g_r_s`
--
ALTER TABLE `category_g_r_s`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `category_portfolio_portfolio`
--
ALTER TABLE `category_portfolio_portfolio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_portfolio_portfolio_category_portfolio_id_foreign` (`category_portfolio_id`),
  ADD KEY `category_portfolio_portfolio_portfolio_id_foreign` (`portfolio_id`);
...
--
-- Индексы таблицы `category_styledets`
--
ALTER TABLE `category_styledets`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `category_styledet_portfolio`
--
ALTER TABLE `category_styledet_portfolio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_styledet_portfolio_category_styledet_id_foreign` (`category_styledet_id`),
  ADD KEY `category_styledet_portfolio_portfolio_id_foreign` (`portfolio_id`);

--
-- Индексы таблицы `category_styledet_productgr`
--
ALTER TABLE `category_styledet_productgr`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_styledet_productgr_category_styledet_id_foreign` (`category_styledet_id`),
  ADD KEY `category_styledet_productgr_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `category_stylevzs`
--
ALTER TABLE `category_stylevzs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `category_stylevz_portfolio`
--
ALTER TABLE `category_stylevz_portfolio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_stylevz_portfolio_category_stylevz_id_foreign` (`category_stylevz_id`),
  ADD KEY `category_stylevz_portfolio_portfolio_id_foreign` (`portfolio_id`);

--
-- Индексы таблицы `category_stylevz_productgr`
--
ALTER TABLE `category_stylevz_productgr`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_stylevz_productgr_category_stylevz_id_foreign` (`category_stylevz_id`),
  ADD KEY `category_stylevz_productgr_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `catformats`
--
ALTER TABLE `catformats`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `catformat_format`
--
ALTER TABLE `catformat_format`
  ADD PRIMARY KEY (`id`),
  ADD KEY `catformat_format_catformat_id_foreign` (`catformat_id`),
  ADD KEY `catformat_format_format_id_foreign` (`format_id`);
...
--
-- Индексы таблицы `format_review`
--
ALTER TABLE `format_review`
  ADD PRIMARY KEY (`id`),
  ADD KEY `format_review_format_id_foreign` (`format_id`),
  ADD KEY `format_review_review_id_foreign` (`review_id`);
...
--
-- Индексы таблицы `garantkachestvas`
--
ALTER TABLE `garantkachestvas`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `portfolio_review`
--
ALTER TABLE `portfolio_review`
  ADD PRIMARY KEY (`id`),
  ADD KEY `portfolio_review_portfolio_id_foreign` (`portfolio_id`),
  ADD KEY `portfolio_review_review_id_foreign` (`review_id`);

--
-- Индексы таблицы `povodis`
--
ALTER TABLE `povodis`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `productgrs`
--
ALTER TABLE `productgrs`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `product_productgr`
--
ALTER TABLE `product_productgr`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_productgr_product_id_foreign` (`product_id`),
  ADD KEY `product_productgr_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `product_productgr_2`
--
ALTER TABLE `product_productgr_2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_productgr_2_product_id_foreign` (`product_id`),
  ADD KEY `product_productgr_2_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `product_productgr_3`
--
ALTER TABLE `product_productgr_3`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_productgr_3_product_id_foreign` (`product_id`),
  ADD KEY `product_productgr_3_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `product_productgr_4`
--
ALTER TABLE `product_productgr_4`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_productgr_4_product_id_foreign` (`product_id`),
  ADD KEY `product_productgr_4_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `product_productgr_5`
--
ALTER TABLE `product_productgr_5`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_productgr_5_product_id_foreign` (`product_id`),
  ADD KEY `product_productgr_5_productgr_id_foreign` (`productgr_id`);

--
-- Индексы таблицы `prod_g_r_s`
--
ALTER TABLE `prod_g_r_s`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prod_g_r_s_category_g_r_s_id_foreign` (`category_g_r_s_id`);
...
--
-- Индексы таблицы `slidergls`
--
ALTER TABLE `slidergls`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `s_e_o_s`
--
ALTER TABLE `s_e_o_s`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `cataloggrs`
--
ALTER TABLE `cataloggrs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT для таблицы `cataloggr_productgr`
--
ALTER TABLE `cataloggr_productgr`
...
--
-- AUTO_INCREMENT для таблицы `category_g_r_s`
--
ALTER TABLE `category_g_r_s`
...
--
-- AUTO_INCREMENT для таблицы `category_portfolio_portfolio`
--
ALTER TABLE `category_portfolio_portfolio`
...
--
-- AUTO_INCREMENT для таблицы `category_styledets`
--
ALTER TABLE `category_styledets`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `category_styledet_portfolio`
--
ALTER TABLE `category_styledet_portfolio`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `category_styledet_productgr`
--
ALTER TABLE `category_styledet_productgr`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `category_stylevzs`
--
ALTER TABLE `category_stylevzs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `category_stylevz_portfolio`
--
ALTER TABLE `category_stylevz_portfolio`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `category_stylevz_productgr`
--
ALTER TABLE `category_stylevz_productgr`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `catformats`
--
ALTER TABLE `catformats`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `catformat_format`
--
ALTER TABLE `catformat_format`
...
--
-- AUTO_INCREMENT для таблицы `format_review`
--
ALTER TABLE `format_review`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `garantkachestvas`
--
ALTER TABLE `garantkachestvas`
...
--
-- AUTO_INCREMENT для таблицы `ourps`
--
ALTER TABLE `ourps`
...
--
-- AUTO_INCREMENT для таблицы `portfolio_review`
--
ALTER TABLE `portfolio_review`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `povodis`
--
ALTER TABLE `povodis`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `productgrs`
--
ALTER TABLE `productgrs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT для таблицы `product_productgr`
--
ALTER TABLE `product_productgr`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT для таблицы `product_productgr_2`
--
ALTER TABLE `product_productgr_2`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT для таблицы `product_productgr_3`
--
ALTER TABLE `product_productgr_3`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT для таблицы `product_productgr_4`
--
ALTER TABLE `product_productgr_4`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT для таблицы `product_productgr_5`
--
ALTER TABLE `product_productgr_5`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `prod_g_r_s`
--
ALTER TABLE `prod_g_r_s`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `slidergls`
--
ALTER TABLE `slidergls`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `s_e_o_s`
--
ALTER TABLE `s_e_o_s`
...
--
-- Ограничения внешнего ключа таблицы `cataloggr_productgr`
--
ALTER TABLE `cataloggr_productgr`
  ADD CONSTRAINT `cataloggr_productgr_cataloggr_id_foreign` FOREIGN KEY (`cataloggr_id`) REFERENCES `cataloggrs` (`id`),
  ADD CONSTRAINT `cataloggr_productgr_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `category_portfolio_portfolio`
--
ALTER TABLE `category_portfolio_portfolio`
  ADD CONSTRAINT `category_portfolio_portfolio_category_portfolio_id_foreign` FOREIGN KEY (`category_portfolio_id`) REFERENCES `category_portfolios` (`id`),
  ADD CONSTRAINT `category_portfolio_portfolio_portfolio_id_foreign` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `category_styledet_portfolio`
--
ALTER TABLE `category_styledet_portfolio`
  ADD CONSTRAINT `category_styledet_portfolio_category_styledet_id_foreign` FOREIGN KEY (`category_styledet_id`) REFERENCES `category_styledets` (`id`),
  ADD CONSTRAINT `category_styledet_portfolio_portfolio_id_foreign` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`);

--
-- Ограничения внешнего ключа таблицы `category_styledet_productgr`
--
ALTER TABLE `category_styledet_productgr`
  ADD CONSTRAINT `category_styledet_productgr_category_styledet_id_foreign` FOREIGN KEY (`category_styledet_id`) REFERENCES `category_styledets` (`id`),
  ADD CONSTRAINT `category_styledet_productgr_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `category_stylevz_portfolio`
--
ALTER TABLE `category_stylevz_portfolio`
  ADD CONSTRAINT `category_stylevz_portfolio_category_stylevz_id_foreign` FOREIGN KEY (`category_stylevz_id`) REFERENCES `category_stylevzs` (`id`),
  ADD CONSTRAINT `category_stylevz_portfolio_portfolio_id_foreign` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`);

--
-- Ограничения внешнего ключа таблицы `category_stylevz_productgr`
--
ALTER TABLE `category_stylevz_productgr`
  ADD CONSTRAINT `category_stylevz_productgr_category_stylevz_id_foreign` FOREIGN KEY (`category_stylevz_id`) REFERENCES `category_stylevzs` (`id`),
  ADD CONSTRAINT `category_stylevz_productgr_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `catformat_format`
--
ALTER TABLE `catformat_format`
  ADD CONSTRAINT `catformat_format_catformat_id_foreign` FOREIGN KEY (`catformat_id`) REFERENCES `catformats` (`id`),
  ADD CONSTRAINT `catformat_format_format_id_foreign` FOREIGN KEY (`format_id`) REFERENCES `formats` (`id`);

--
-- Ограничения внешнего ключа таблицы `format_review`
--
ALTER TABLE `format_review`
  ADD CONSTRAINT `format_review_format_id_foreign` FOREIGN KEY (`format_id`) REFERENCES `formats` (`id`),
  ADD CONSTRAINT `format_review_review_id_foreign` FOREIGN KEY (`review_id`) REFERENCES `reviews` (`id`);

--
-- Ограничения внешнего ключа таблицы `portfolio_review`
--
ALTER TABLE `portfolio_review`
  ADD CONSTRAINT `portfolio_review_portfolio_id_foreign` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`),
  ADD CONSTRAINT `portfolio_review_review_id_foreign` FOREIGN KEY (`review_id`) REFERENCES `reviews` (`id`);

--
-- Ограничения внешнего ключа таблицы `product_productgr`
--
ALTER TABLE `product_productgr`
  ADD CONSTRAINT `product_productgr_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `product_productgr_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `product_productgr_2`
--
ALTER TABLE `product_productgr_2`
  ADD CONSTRAINT `product_productgr_2_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `product_productgr_2_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `product_productgr_3`
--
ALTER TABLE `product_productgr_3`
  ADD CONSTRAINT `product_productgr_3_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `product_productgr_3_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `product_productgr_4`
--
ALTER TABLE `product_productgr_4`
  ADD CONSTRAINT `product_productgr_4_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `product_productgr_4_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `product_productgr_5`
--
ALTER TABLE `product_productgr_5`
  ADD CONSTRAINT `product_productgr_5_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `product_productgr_5_productgr_id_foreign` FOREIGN KEY (`productgr_id`) REFERENCES `productgrs` (`id`);

--
-- Ограничения внешнего ключа таблицы `prod_g_r_s`
--
ALTER TABLE `prod_g_r_s`
  ADD CONSTRAINT `prod_g_r_s_category_g_r_s_id_foreign` FOREIGN KEY (`category_g_r_s_id`) REFERENCES `category_g_r_s` (`id`);

...
@section('styles')
    <link rel="stylesheet" href="/css/profile/inner/styles.css">
@endsection
            ...
            <div class="container">
                ...
                <div class="personalArea__wrap">
                        ...
                        <a href="#" class="menu__item">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke="#5F5839" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            Настройки
                        </a>
                        <a href="#" class="menu__item">
                        ...
                        <a href="#" class="menu__item exit">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    fill="#C8A98D" />
                                <path d="M9.16667 13.3333L13.3333 10L9.16667 6.66666V9.1675H2.5V10.8342H9.16667V13.3333Z"
                                    fill="#C8A98D" />
                            </svg>
                            Выйти
                        </a>
                    ...
                    <form action="" class="personalArea__form">
                        ...
                        <div class="input-group">
                            <input type="text" name="userPhone" placeholder="+7 (900) 123 45 67" />
                            <label for="">Телефон</label>
                        </div>
                        <div class="title delivery">Доставка</div>
                        <div class="city">
                            <div class="input-group city">
                                <input type="text" name="userCity" placeholder="Морозовск" />
                        ...
                        <div class="house">
                            <div class="input-group street">
                                <input type="text" name="userStreet" placeholder="Петроградская" />
                                <label for="">Улица</label>
                            </div>
                            <div class="input-group home">
                                <input type="text" name="userHome" placeholder="12" />
                                <label for="">Дом</label>
                            </div>
                        </div>
                        <div class="link__wr">
                            <a href="#" class="link--arrow-black" type="submit">Сохранить</a>
                            изменения сохранены.
                        </div>
                    </form>
                </div>

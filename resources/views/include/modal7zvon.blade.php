<div class="modal-event">
  <form action="{{route('send.modal.5')}}" enctype="multipart/form-data" method="post" class="modal-event-wrap">
    @csrf
    <div class="btn-close">
      <svg
        width="28"
    ...
    <div class="inputs">
      <div class="leftBlock">
        <div class="input-group">
          ...
          <input type="text" required name="userzvon" placeholder="Ваше имя" />
        </div>
        <div class="input-group">
      ...
      <div class="rightBlock">
        <div class="input-group">
          ...
          <textarea name="messzvon"></textarea>
        </div>
      </div>
    </div>
    <div class="bottom">

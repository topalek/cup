<div class="modal-event">
  <form action="{{route('send.modal.4')}}" enctype="multipart/form-data" method="post" class="modal-event-wrap">
    @csrf
    <div class="btn-close">
      <svg
        width="28"
    ...
    <div class="title">откликнуться</div>
    ...
    <div class="bottom">
      <input type="hidden" name="messmrv2" value="{{ $page->title }}"/>

...
@section('scripts')
  <script src="/js/solution-catalog/app.js"></script>
  @include('include.addbasket')
  <script>
    $(".solution-catalog__add").on("click", function () {
      $(".modal--replace").addClass("modal--active");
      $("body").addClass("overflow");
    });
    $(".solution-catalog__product-icon--replace").on("click", function () {
      $(".modal--replace").addClass("modal--active");
      $("body").addClass("overflow");
    });
              ...
              @include('include.bread')
                ...
                <div class="description__inner">
                    ...
                    <div class="description__item description__info">
                        ...
                        @endforeach
                        <div class="tags">
                            <a class="tag_gr" href="{{ '/menu/'.$pathcat }}">{{$namecat}}</a>
                        </div>
                        ...
                        <div class="description__price">{{ $product->price_full }} руб.</div>
                        
                        <div class="description__wieght">{{ $product->weight_full }} г.</div>
                        <div class="description__other">
                            <button class="description__other-btn inCartKor js-add-cart" data-id="{{$product->id}}" data-pr="productgr">
                                в корзину
                            </button>
                            <a class="description__other-link link--arrow-brown inCartOne"
                              data-id="{{$product->id}}" data-pr="productgr" data-href="{{URL::to('/basket')}}">В 1 клик</a>
                        </div>
                    </div>
                </div>
            </div>
